...
function add_buttons() {
    ...
    let names = ['Isotropic', 'Triaxial'];
        ...
        for ( var i=0;i<names.length;i++ ) {
            ...
            controls.interaction.selectStartHandlers[type] = onSelectStart;
            controls.interaction.selectEndHandlers[type] = onSelectEnd;
...
function onSelectStart( object, controller ) {
        window.location.href = object.userData.url + ".html"; // simulate mouse click
}

function onSelectEnd( object, controller ) {
};
