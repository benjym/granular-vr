...
var uniforms = {
  ...
  // A: { value: [] }, // Size N*N
  xview: { value: 0.0 }, //Size N-3
  xpart: { value: 0.0 }, //Size N-3
  // x4: { value: 0 },
  // x4p: { value: 0 },
  R: { value: 0.5 },
  ambient: { value: 1.0 },
...
//   for (var j=0; j<N; j++) {
//     let ij = i*N + j;
//     if (ij % N == Math.floor(ij / N)) uniforms.A[i][j] = 1;
//     else uniforms.A.value[i][j] = 0;
//   }
// }
...
var NDDEMShader = new THREE.ShaderMaterial({
  ...
  vertexShader: [
    ...
    "x_rotated.x = A[0][0]*x.x + A[0][1]*x.y + A[0][2]*x.z + A[0][3]*x.w;",
    "x_rotated.y = A[1][0]*x.x + A[1][1]*x.y + A[1][2]*x.z + A[1][3]*x.w;",
    "x_rotated.z = A[2][0]*x.x + A[2][1]*x.y + A[2][2]*x.z + A[2][3]*x.w;",
    "x_rotated.w = A[3][0]*x.x + A[3][1]*x.y + A[3][2]*x.z + A[3][3]*x.w;",
